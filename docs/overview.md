...
- The window is two panes, the sidebar with the workspace picker and the conversation list, and the thread beside it, and a third while a file or a run is open beside it. One of those at a time: opening a run closes the file, and opening a file closes the run. The sidebar slides out of the way and back, and stays as you left it.
